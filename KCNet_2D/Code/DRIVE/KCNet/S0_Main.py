...
if __name__ == "__main__":
    ...
    root_dir = "/data/lab/DSCNet/KCNet_2D/"  # todo
    ...
    parser.add_argument("--save_path",
                        default=root_dir + "Results/DRIVE/KCNet/",
                        help="Save dir")
    parser.add_argument(
        "--save_path_max",
        default=root_dir + "Results/DRIVE/KCNet_max/",
        help="Save max dir",
    )
    ...
    parser.add_argument("--model_name_max",
                        default="KCNet_DRIVE_max",
                        help="Max Weights name")
    parser.add_argument("--log_name",
                        default="KCNet_DRIVE.log",
                        help="Log name")
    ...
    parser.add_argument("--kernel_size",
                        default=3,  # 如果您使用的是3x3的标准卷积核，请更新这个值
                        type=int,
                        help="kernel size for StandardConv")
    ...
    parser.add_argument("--log_interval", default=10, type=int, help="Interval at which to log training status")
    ...
    parser.add_argument("--n_epochs", default=2, type=int, help="Epoch Num")
